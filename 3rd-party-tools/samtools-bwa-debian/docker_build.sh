...
# Registries and tags
GCR_URL="us.gcr.io/broad-gotc-prod/samtools-bwa-debian"
QUAY_URL="quay.io/broadinstitute/gotc-prod-samtools_bwa-debian"

# SAMTOOLS and BWA version
BWA_VERSION="0.7.17"
SAMTOOLS_VERSION="1.11"

# Necessary tools and help text
TOOLS=(docker gcloud)
HELP="$(basename "$0") [-h|--help] [-b|--bwa_version] [-s|--samtools_version] [-t|tools] -- script to build the SAMTOOLS/BWA image and push to GCR & Quay
...
function main(){
    ...
    IMAGE_TAG="$DOCKER_IMAGE_VERSION-$BWA_VERSION-$SAMTOOLS_VERSION-$TIMESTAMP"
