...
# Registries and tags
GCR_URL="us.gcr.io/broad-gotc-prod/samtools-bwa-mem-2-lisa"
QUAY_URL="quay.io/broadinstitute/gotc-prod-samtools_bwa-mem-2-lisa"

# BWA version
BWA_VERSION="2.0pre2_x64-linux"

# Necessary tools and help text
TOOLS=(docker gcloud)
HELP="$(basename "$0") [-h|--help] [-b|--bwa_version] [-t|tools] -- script to build the SAMTOOLS/BWA-MEM2-LISA image and push to GCR & Quay
