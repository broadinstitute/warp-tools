...
# Registries and tags
GCR_URL="us.gcr.io/broad-gotc-prod/hisat-3n"
QUAY_URL="quay.io/broadinstitute/hisat-3n"

#  version
HISAT3N_VERSION="2.2.1"
...
where:
    ...
    -v|--version Version of HISAT-3N to use (default: $HISAT3N_VERSION)
...
function main(){
    ...
    IMAGE_TAG="$DOCKER_IMAGE_VERSION-$HISAT3N_VERSION-$TIMESTAMP"

    echo "building and pushing GCR Image - $GCR_URL:$IMAGE_TAG"
    docker build --no-cache -t "$GCR_URL:$IMAGE_TAG" \
        --build-arg HISAT3N_VERSION="$HISAT3N_VERSION" "$DIR" 
