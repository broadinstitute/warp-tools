...
#### `docker pull us.gcr.io/broad-gotc-prod/imputation-beagle:0.0.2-17Dec24.224-1739986611`
...
```bash
$ docker pull us.gcr.io/broad-gotc-prod/imputation-beagle:0.0.2-17Dec24.224-1739986611
$ docker inspect us.gcr.io/broad-gotc-prod/imputation-beagle:0.0.2-17Dec24.224-1739986611
```
...
```bash
$ docker run --rm -it \
    us.gcr.io/broad-gotc-prod/imputation-beagle:0.0.2-17Dec24.224-1739986611 java -jar /usr/gitc/beagle.17Dec24.224.jar
```