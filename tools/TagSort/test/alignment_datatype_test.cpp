...
{
  LineFields lf("a\tbbb\tc\td\t1234\t1234\t123\t1\t0.12\t4.56e10\t0.6\t0.7\t8\t0\t1\t0\t1\t0.9");
...
{
  LineFields lf("\t\t\td\t1234\t1234\t123\t1\t0.12\t4.56e10\t0.6\t0.7\t8\t0\t1\t0\t1\t0.9");
...
{
  LineFields lf("a\tbbb\tc\td\t1234\t1234\t123\t1\t0.12\t4.56e10\t0\t0\t0\t0\t0\t0\t0\t0\t");
}
...
{
  EXPECT_EXIT(LineFields lf("a\tb\tc\td\t1234\t1234\t0\t\t0\t0\t0\t0\t0\t0\t0\t0\t0\t0"),
...
{
  EXPECT_EXIT(LineFields lf("a\tb\tc\td\t1234\t1234\t1\t2\tgibberish\t1.23"),
              testing::ExitedWithCode(1),
...
{
  EXPECT_EXIT(LineFields lf("a\tb\tc\td\t1234\t1234\tBAD123\t2"),
              testing::ExitedWithCode(1),
...
{
  EXPECT_EXIT(LineFields lf("a\tb\tc\td\t1234\t1234\t123BAD\t2"),
              testing::ExitedWithCode(1),
...
{
  EXPECT_EXIT(LineFields lf("a\tb\tc\td\t1234\t1234\t1.23\t2"),
              testing::ExitedWithCode(1),
              testing::HasSubstr("Extra characters after int"));
}
...
{
  EXPECT_EXIT(LineFields lf("a\tb\tc\td\t1234\t1234\t0\t0\t0\t0\t0\t0\t0\t0\t0\t0\t0\t0\t0"),
              testing::ExitedWithCode(1),
